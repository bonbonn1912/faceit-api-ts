<template>
  <div class="rahmen bg-gray-600 w-screen h-screen flex felx-row">
    <div
      class="LeftHalf w-1/2 h-full bg-gray-600 flex flex-col justify-center items-center"
    >
      <div class="titel flex w-1/2 font-bold text-lg text-white">
        Last 8 Requests
      </div>
    ...
    <div
      class="RightHalf w-1/2 h-full bg-gray-600 flex flex-col justify-center items-center"
    >
      <div
        class="titel flex w-3/4 font-bold text-lg text-white items-center align-middle"
      >
        Last 6 Matches
      </div>
    ...
    <div
      class="navbar w-full h-8 text-white font-bold text-xl fixed bottom-0 bg-gray-700 flex items-center justify-center"
    >
